export default class Human {
  ...
  marsYearsPassedUntil(futureAge) {
    let marsYearsUntil = parseInt((futureAge - this.currentAge) / 1.88);
    this.marsYearsUntil = marsYearsUntil
  }
  ...
  jupiterYearsPassedSince(previousAge) {
